...
import {
  ArrowLeft, Save, Plus, Trash2, Calendar, Clock, MapPin,
  User, Wrench, Bell, Lock, AlertTriangle, CheckSquare,
} from "lucide-react";
        ...
        <div className="rounded-[var(--radius-lg)] border border-[var(--color-border)] bg-[var(--color-surface)] p-5 shadow-sm space-y-4">
          ...
          <div className="grid gap-4 sm:grid-cols-3">
            <FormField label="Data" required>
              <Input name="data" type="date" defaultValue={searchParams.get("data") ?? hoje} required />
            </FormField>
